...
const AddStationaryModal = () => {
  ...
  const handleCreateItemList: SubmitHandler<IStationaryList> = async (
    ...
    console.log(stationaryList, "stationaryList");
  };
        ...
        <div className="flex flex-col gap-3 w-full ">
          <div>
            <Whisper speaker={<Tooltip>Item Name</Tooltip>}>
              <label htmlFor="stationaryItemId" className="text-sm font-medium">
                Item Name
                <InfoOutlineIcon />
              </label>
            </Whisper>
        ...
        <div className="flex flex-col gap-3 w-full ">
          <div>
            <Whisper
              speaker={
                <Tooltip>
                  <span className="text-[11px]">Expenses greater than 0</span>
                </Tooltip>
              }
            >
