...
import { Courier, Prisma, StationaryItem } from '@prisma/client';
...
import {
  ...
  StationaryItemSearchableFields,
  StyleWiseCourierSearchableFields,
  courierRelationalFields,
  courierRelationalFieldsMapper,
  stationaryItemRelationalFields,
  stationaryItemRelationalFieldsMapper,
} from './stationaryItem.constants';
import {
  ICourierCreateRequest,
  ICourierFilterRequest,
  ICourierUpdateRequest,
  IStationaryItemCreateRequest,
  IStationaryItemFilterRequest,
  IStyleWiseCourier,
} from './stationaryItem.interface';
